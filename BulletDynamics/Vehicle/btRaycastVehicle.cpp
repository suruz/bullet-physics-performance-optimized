...
//	up.normalize();
	...
	//wheel.m_CustomMtxRotY = steeringMat;
	//wheel.m_CustomWorldTransform.setBasis(rotatingMat);
	//wheel.m_CustomWorldTransform.setOrigin(wheel.m_raycastInfo.m_hardPointWS + wheel.m_raycastInfo.m_wheelDirectionWS * wheel.m_raycastInfo.m_suspensionLength);
