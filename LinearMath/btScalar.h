...
#include <float.h>
	...
	//non-windows systems
		...
		#define SIMD_FORCE_INLINE inline
		#define ATTRIBUTE_ALIGNED16(a) a __attribute__ ((aligned (4)))
		#ifndef assert
		#include <assert.h>
		#endif
		#define btAssert assert
...
{ 
	...
	//unsigned int rotDeg =(unsigned int)(x / 0.01745329251994329547);
	//rotDeg = rotDeg * 182;
	//return FX_FX16_TO_F32(FX_CosIdx(rotDeg));
...
{ 
	...
	//unsigned int rotDeg =(unsigned int)(x / 0.01745329251994329547);
	//rotDeg = rotDeg * 182;
	//return FX_FX16_TO_F32(FX_SinIdx(rotDeg));
